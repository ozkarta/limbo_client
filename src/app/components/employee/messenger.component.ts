...
@Component({
  selector: 'app-root',
  templateUrl: '../../views/employee/messenger.component.html',
  styleUrls: ['../../styles/employee/messenger.style.css']
})
export class EmployeeMessengerComponent implements OnInit {
  title = 'app works!';
      ...
      for (let conversation of response.data) {
        ...
        for (let message of conversation.message) {
          ...
          if (message.sender) {
            ...
            for (let chatter of newConversation.otherChatters){
